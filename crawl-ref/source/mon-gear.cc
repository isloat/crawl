                         ...
                         bool give_aux_melee = true, bool spectral_orcs = false)
{
    ...
    // TODO: let specs handle weighted lists of brands
    // TODO: add another list for !melee_only (takes precedence)
    ...
    static const map<monster_type, mon_weapon_spec> primary_weapon_specs = {
        ...
        { MONS_DANCING_WEAPON,          { NAGA_WEAPONS } },
    ...
    const mon_weapon_spec *weapon_spec = map_find(primary_weapon_specs, type);
    if (weapon_spec)
    {
