...
const Branch branches[NUM_BRANCHES] =
{
    ...
    { BRANCH_DIS, BRANCH_VESTIBULE, 1, 1, 4, 28,
    ...
    { BRANCH_GEHENNA, BRANCH_VESTIBULE, 1, 1, 4, 28,
      BFLAG_NO_ITEMS | BFLAG_DANGEROUS_END,
    ...
    { BRANCH_COCYTUS, BRANCH_VESTIBULE, 1, 1, 4, 28,
      BFLAG_NO_ITEMS | BFLAG_DANGEROUS_END,
    ...
    { BRANCH_TARTARUS, BRANCH_VESTIBULE, 1, 1, 4, 28,
      BFLAG_NO_ITEMS | BFLAG_DANGEROUS_END,
