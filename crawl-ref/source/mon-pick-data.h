...
{ // Dungeon (OOD cap: 27)
  ...
  {  1, 11,  515, SEMI, MONS_LEOPARD_GECKO },
  ...
  { 11, 21,  335, SEMI, MONS_ACID_DRAGON },
...
{ // Hell
  {  1,  1,   14, FLAT, MONS_HELL_RAT },
  {  1,  1,   14, FLAT, MONS_DEMONIC_CRAWLER },
  {  1,  1,   27, FLAT, MONS_HELL_HOUND },
  {  1,  1,   18, FLAT, MONS_HELL_HOG },
  {  1,  1,   27, FLAT, MONS_HELL_KNIGHT },
  {  1,  1,   27, FLAT, MONS_NECROMANCER },
  {  1,  1,    5, FLAT, MONS_HELLEPHANT },
  {  1,  1,    5, FLAT, MONS_TENTACLED_MONSTROSITY },
  {  1,  1,   16, FLAT, MONS_RED_DEVIL },
  {  1,  1,   16, FLAT, MONS_ICE_DEVIL },
  {  1,  1,    6, FLAT, MONS_RUST_DEVIL },
  {  1,  1,   50, FLAT, MONS_SUN_DEMON },
  {  1,  1,   94, FLAT, MONS_SOUL_EATER },
  {  1,  1,   94, FLAT, MONS_REAPER },
  {  1,  1,    5, FLAT, MONS_HELLION },
  {  1,  1,    5, FLAT, MONS_TORMENTOR },
  {  1,  1,   10, FLAT, MONS_SHADOW_DEMON },
  {  1,  1,   10, FLAT, MONS_BLIZZARD_DEMON },
  {  1,  1,   10, FLAT, MONS_BALRUG },
  {  1,  1,    8, FLAT, MONS_CACODEMON },
  {  1,  1,    2, FLAT, MONS_FLAYED_GHOST },
  {  1,  1,    2, FLAT, MONS_ANCIENT_CHAMPION },
  { 0,0,0,FLAT,MONS_0 }
};

static const pop_entry pop_dis[] =
{ // Dis
  {  1, 12,   20, PEAK, MONS_DANCING_WEAPON },
  {  1,  9,    5, FLAT, MONS_IRON_GOLEM },
  {  1, 12,   20, SEMI, MONS_IRON_DRAGON },
  {  0, 12,   50, RISE, MONS_IRON_GIANT },
  {  1,  4,   10, FALL, MONS_HELL_HOUND },
  {  1,  9,   30, FALL, MONS_HELL_KNIGHT },
  {  0,  5,  100, FLAT, MONS_IRON_IMP },
  {  1,  9,  105, FLAT, MONS_RUST_DEVIL },
  {  0,  9,   25, FALL, MONS_RED_DEVIL },
  {  0,  9,   25, FALL, MONS_ICE_DEVIL },
  { -1, 14,   35, SEMI, MONS_SOUL_EATER },
  {  1, 12,   90, SEMI, MONS_REAPER },
  {  1, 12,   80, SEMI, MONS_TORMENTOR },
  {  1, 12,   35, FLAT, MONS_HELLION },
  {  3, 16,    1, RISE, MONS_BRIMSTONE_FIEND },
  {  1,  8,  100, FLAT, MONS_ZOMBIE },
  {  1,  8,   60, FLAT, MONS_SKELETON },
  {  1,  5,   30, FALL, MONS_WIGHT },
  {  1,  5,   20, FALL, MONS_FLYING_SKULL },
  {  1,  9,   40, FLAT, MONS_SKELETAL_WARRIOR },
  {  1,  5,   40, FLAT, MONS_PHANTASMAL_WARRIOR },
  {  6, 12,   10, FLAT, MONS_PHANTASMAL_WARRIOR },
  {  1, 12,    1, SEMI, MONS_VAMPIRE_MAGE },
  {  1, 12,    1, SEMI, MONS_VAMPIRE_KNIGHT },
  {  1, 12,    5, PEAK, MONS_BONE_DRAGON },
  {  2, 13,    5, PEAK, MONS_LICH },
  { 0,0,0,FLAT,MONS_0 }
};

static const pop_entry pop_geh[] =
{ // Gehenna
  {  1,  3,   15, FALL, MONS_FIRE_BAT },
  {  1,  5,   10, FALL, MONS_FIRE_CRAB },
  {  1,  9,   20, FLAT, MONS_EFREET },
  {  1,  5,   50, FALL, MONS_HELL_HOUND },
  {  1,  9,   60, FLAT, MONS_HELL_HOG },
  {  1,  9,   55, FLAT, MONS_HELL_KNIGHT },
  {  0,  4,  100, FALL, MONS_CRIMSON_IMP },
  {  1,  9,   90, FALL, MONS_RED_DEVIL },
  {  1,  3,   30, FALL, MONS_RUST_DEVIL },
  { -1,  9,   80, FALL, MONS_SUN_DEMON },
  { -1, 14,   30, SEMI, MONS_SOUL_EATER },
  {  1, 12,   45, SEMI, MONS_TORMENTOR },
  {  1, 12,   40, SEMI, MONS_REAPER },
  {  1,  6,   60, FLAT, MONS_HELLION },
  {  7,  7,   30, FLAT, MONS_HELLION },
  {  1, 12,   55, FLAT, MONS_BALRUG },
  {  3, 16,    1, RISE, MONS_HELL_SENTINEL },
  {  1,  5,  100, FLAT, MONS_SKELETON },
  {  1,  5,   60, FLAT, MONS_ZOMBIE },
  {  1,  5,   20, FALL, MONS_WIGHT },
  {  1,  5,   20, FALL, MONS_FLYING_SKULL },
  {  1,  9,   35, FLAT, MONS_SKELETAL_WARRIOR },
  {  1,  5,   40, FLAT, MONS_FLAYED_GHOST },
  {  6, 12,   20, FLAT, MONS_FLAYED_GHOST },
  {  1, 12,    1, SEMI, MONS_VAMPIRE_KNIGHT },
  {  1, 12,    5, FLAT, MONS_BONE_DRAGON },
  {  1, 13,    5, SEMI, MONS_LICH },
  { 0,0,0,FLAT,MONS_0 }
};

static const pop_entry pop_coc[] =
{ // Cocytus
  {  1,  4,   65, FALL, MONS_ICE_BEAST },
  {  1,  9,   60, FLAT, MONS_SIMULACRUM },
  {  1,  5,   45, FLAT, MONS_ICE_DRAGON },
  {  6, 12,   25, FLAT, MONS_ICE_DRAGON },
  {  0, 12,   55, RISE, MONS_SHARD_SHRIKE },
  {  1,  5,   20, FALL, MONS_NECROMANCER },
  {  0,  4,  100, FALL, MONS_WHITE_IMP },
  {  1,  9,  100, FALL, MONS_ICE_DEVIL },
  { -1, 14,   35, SEMI, MONS_SOUL_EATER },
  {  1, 12,   50, SEMI, MONS_TORMENTOR },
  {  1, 12,   50, SEMI, MONS_REAPER },
  {  1, 12,   60, SEMI, MONS_BLIZZARD_DEMON },
  {  3, 16,    1, RISE, MONS_TZITZIMITL },
  {  1,  5,   80, FLAT, MONS_SKELETON },
  {  1,  5,   60, FLAT, MONS_ZOMBIE },
  {  1,  5,   20, FALL, MONS_WIGHT },
  {  1,  4,   20, FALL, MONS_FLYING_SKULL },
  {  1,  9,   40, FLAT, MONS_HUNGRY_GHOST },
  {  1,  5,   80, FLAT, MONS_FREEZING_WRAITH },
  {  1,  1,    1, SEMI, MONS_VAMPIRE_MAGE },
  {  1, 12,    5, FLAT, MONS_BONE_DRAGON },
  {  0, 13,   10, SEMI, MONS_LICH },
  { 0,0,0,FLAT,MONS_0 }
};

static const pop_entry pop_tar[] =
{ // Tartarus
  {  1,  9,   20, SEMI, MONS_SPECTRAL_THING },
  {  1,  9,   10, FLAT, MONS_GHOST_CRAB },
  {  1, 12,    5, FLAT, MONS_DEATH_DRAKE },
  {  1, 12,   25, SEMI, MONS_SHADOW_DRAGON },
  {  1, 12,   20, SEMI, MONS_SILENT_SPECTRE },
  {  1, 13,   80, RISE, MONS_DOOM_HOUND },
  {  1,  4,    5, FALL, MONS_HELL_HOUND },
  {  1,  5,   10, FALL, MONS_HELL_KNIGHT },
  {  1,  5,   10, FLAT, MONS_NECROMANCER },
  {  1,  4,   50, FALL, MONS_SHADOW_IMP },
  {  1,  9,   60, FALL, MONS_HELLWING },
  {  1,  3,   20, FALL, MONS_ICE_DEVIL },
  {  1,  5,   90, FLAT, MONS_SOUL_EATER },
  {  6, 12,   30, FLAT, MONS_SOUL_EATER },
  {  1, 12,   50, SEMI, MONS_TORMENTOR },
  {  1, 12,   65, SEMI, MONS_REAPER },
  {  1, 12,   30, FLAT, MONS_HELLION },
  {  1, 12,   40, SEMI, MONS_SHADOW_DEMON },
  {  3, 16,    1, RISE, MONS_ICE_FIEND },
  {  1,  5,   50, FLAT, MONS_SKELETON },
  {  1,  5,   70, FLAT, MONS_ZOMBIE },
  {  1,  4,   30, FALL, MONS_SHADOW },
  {  1,  9,   30, FLAT, MONS_FREEZING_WRAITH },
  {  1,  9,   40, FLAT, MONS_SHADOW_WRAITH },
  {  1,  9,   15, FLAT, MONS_VAMPIRE_MAGE },
  {  1, 12,   15, FLAT, MONS_VAMPIRE_KNIGHT },
  {  1, 12,   30, FLAT, MONS_PHANTASMAL_WARRIOR },
  {  3, 12,   15, SEMI, MONS_JIANGSHI },
  {  1, 12,   40, SEMI, MONS_FLAYED_GHOST },
  {  3, 12,   25, SEMI, MONS_REVENANT },
  {  1, 12,   20, FLAT, MONS_BONE_DRAGON },
  {  0, 13,   20, SEMI, MONS_LICH },
  { 0,0,0,FLAT,MONS_0 }
};
...
{ // Hell branch water monsters
  {  1,  4,   150, FLAT, MONS_SPINY_FROG },
  {  1,  4,   120, FLAT, MONS_ALLIGATOR },
  {  1,  4,   130, FLAT, MONS_ANACONDA },
  {  1,  4,   230, FLAT, MONS_HYDRA },
  {  1,  4,    37, FLAT, MONS_KRAKEN },
  {  1,  4,   115, FLAT, MONS_WATER_ELEMENTAL },
...
{ // Hell branch lava monsters
  {  1,  6,   300, FALL, MONS_FIRE_ELEMENTAL },
  {  1,  3,    25, FALL, MONS_MOLTEN_GARGOYLE },
  {  1,  4,    25, FLAT, MONS_SMOKE_DEMON },
